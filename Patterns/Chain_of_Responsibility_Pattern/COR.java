package Patterns.Chain_of_Responsibility_Pattern;
...
class ThousandHandler extends MoneyHandler {
    ...
    public void dispense(int amount) {
        ...
        if(remainingAmount > 0) {
            ...
            else System.out.println("Remaining amount of " + remainingAmount + " cannot be fulfilled (Insufficinet fund in ATM)");
        }
    }
}
