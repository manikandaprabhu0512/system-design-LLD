package LSP.LSP_GuideLines.PropertyRules;

// Subclass methods should not be allow state changes that the base class never allowed.
...
public class HistoryInvariants {
