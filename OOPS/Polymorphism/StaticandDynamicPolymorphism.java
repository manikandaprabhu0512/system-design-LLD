...
abstract class SDCar {
    protected String brand;
    protected String model;
    protected boolean isEngineOn;
    protected int currentSpeed;

    public SDCar(String brand, String model) {
        this.brand = brand;
        this.model = model;
...
class SDManualCar extends SDCar {
    private int currentGear;

    public SDManualCar(String brand, String model) {
        super(brand, model);
        this.currentGear = 0;
    }
...
class SDElectricCar extends SDCar {
    private int batteryLevel;

    public SDElectricCar(String brand, String model) {
        super(brand, model);
...
public class StaticandDynamicPolymorphism {
    public static void main(String[] args) {
        SDCar myManualCar = new SDManualCar("Ford", "Mustang");
        ...
        SDCar myElectricCar = new SDElectricCar("Tesla", "Model S");
