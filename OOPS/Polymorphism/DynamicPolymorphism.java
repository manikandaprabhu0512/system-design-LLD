...
abstract class DCar {
    ...
    public DCar(String brand, String model) {
        this.brand = brand;
        this.model = model;
...
class DManualCar extends DCar {
    private int currentGear;

    public DManualCar(String brand, String model) {
        super(brand, model);
        this.currentGear = 0;
    }
...
class DElectricCar extends DCar {
    private int batteryLevel;

    public DElectricCar(String brand, String model) {
        super(brand, model);
...
public class DynamicPolymorphism {
    public static void main(String[] args) {
        DCar myManualCar = new DManualCar("Suzuki", "WagonR");
        ...
        DCar myElectricCar = new DElectricCar("Tesla", "Model S");
