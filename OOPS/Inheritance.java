class ICar {
    ...
    public ICar(String brand, String model) {
        this.brand = brand;
        this.model = model;
...
class ElectricCar extends ICar {
    ...
    public void chargeBattery() {
        batteryLevel = 100;
        System.out.println(brand + " " + model + " : Battery is charged to " + batteryLevel + "%");
    }
}
